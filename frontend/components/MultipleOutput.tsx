...
export function MultipleOutput({
  className,
}: {
  className?: string;
}) {
  ...
  return (
    <div
      className={cn(
        "relative mt-2 flex h-[280px] w-[600px]",
        className,
      )}
      ref={containerRef}
    >
      <div className="flex size-full flex-row items-stretch justify-between gap-10 max-w-lg">
        <div className="flex flex-col justify-center gap-2">
          ...
          <Circle ref={div3Ref}>
            <Image src="/flask.png" alt='flask' width={50} height={50}/>
          </Circle>
          <Circle ref={div4Ref}>
            <Image src="/api.png" alt='api' width={50} height={50}/>
          </Circle>
          <Circle ref={div5Ref}>
            <Image src="/cooking.png" alt='cooking' width={50} height={50}/>
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16">
          <Image src="/model.png" alt='model' width={50} height={50}/>
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref}>
